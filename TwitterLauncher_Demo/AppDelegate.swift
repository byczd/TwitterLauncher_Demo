...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        window?.backgroundColor = UIColor(red: 29 / 255.0, green: 161 / 255.0, blue: 242 / 255.0, alpha: 1)     // 蓝色背景
        ...
        logoLayer.contents = #imageLiteral(resourceName: "twitter_logo_white").cgImage
        ...
        mainViewAnimation.beginTime = CACurrentMediaTime() + 0.4
